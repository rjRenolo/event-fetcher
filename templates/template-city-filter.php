...
<div id="city-filter">
    <h1><span style="font-weight: 100;">Find Stuff to Do</span><br>in {{city}}</h1>
    <div class="grid-wrap">

        <div  v-for="event in cityEvents">
            <div class="tile" >
                <div class="wrapper">
...
var cityFilter = new Vue({
    ...
    mounted(){
        ...
        var holder = urlParam.city
        this.city = holder.toUpperCase();
        
        this.cityEvents = this.events.filter((event) => event.city.toUpperCase() === this.city.toUpperCase()) 
    }
})
</script>
